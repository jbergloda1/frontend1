    ...
    <div class="container fluid">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          >
            <b-icon icon="cart4" aria-hidden="true" class="iccart"></b-icon>Add
            to cart</b-button
          >
        </div>
...
import Bestselling from "../layout/Bestselling.vue";
...
export default {
  ...
  methods: {
    ...
    addItemToCart() {
      ...
      axios
        .post(`http://127.0.0.1:8000/api/add-cart/` + this.customer.id)
        .then((res) => {
          Swal.fire(
            "Đã thêm!",
